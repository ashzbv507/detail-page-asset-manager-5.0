...
const AMANTE_IMBEDDING_ITEM_GROUPS: ItemGroup[] = [
  ...
  { label: "기타", items: ["토퍼", "소파패드", "프릴 소파패드", "바디필로우", "베개솜", "이불솜", "커튼", "담요", "냉감 토퍼", "이불 겸 패드"] },
];
...
function vendorClass(vendor: string) {
  ...
  if (vendor.includes("29cm")) return "vendor-29cm";
  if (vendor.includes("현대")) return "vendor-hyundai";
